...
class TestPreferences:
    ...
    def test_from_dict(self):
        ...
        data = {
            "port_range": {"start": 70000, "end": 70100},
        ...
        assert prefs.port_range_start == 70000
        assert prefs.port_range_end == 70100
    ...
    def test_from_dict_partial(self):
        ...
        data = {
            "port_range": {"start": 80000}
        }
        
        prefs = Preferences.from_dict(data)
        
        assert prefs.port_range_start == 80000
        assert prefs.port_range_end == DEFAULTS["port_range"]["end"]
        assert prefs.last_profile is None
    ...
    def test_to_dict(self):
        ...
        assert result["port_range"]["start"] == 70000
        assert result["port_range"]["end"] == 70100
    ...
    def test_save(self):
        ...
        assert written_data["port_range"]["start"] == 70000
